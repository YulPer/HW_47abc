...
public class ExtentReportsTest {
	...
	public void ConfirmationTest() throws Exception {
		...
		//
		// Assert.assertEquals(p.getProperty("fname_value"),
		// Common.getValue(By.id(p.getProperty("el_07"))));
		// Assert.assertEquals(p.getProperty("lname_value"),
		// Common.getValue(By.id(p.getProperty("el_09"))));
		// Assert.assertEquals(p.getProperty("email_value"),
		// Common.getValue(By.id(p.getProperty("el_11"))));
		// Assert.assertEquals(p.getProperty("phone_value"),
		// Common.getValue(By.id(p.getProperty("el_13"))));
